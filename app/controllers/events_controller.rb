class EventsController < ApplicationController
  ...
  swagger_api :create do
    ...
    param :form, :address, :string, :required, "Event full address WARNING - pass here full address (concatenated street, state, city, country)"
    param :form, :country, :string, :required, "Event country"
    param :form, :city, :string, :required, "Event city"
    param :form, :state, :string, :required, "Event state"
    param :form, :street, :string, :required, "Event street adddress"
